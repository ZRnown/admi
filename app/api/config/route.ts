...
function accountToFrontend(
  ...
  return {
    ...
    name: account.name,
    type: account.type,
    forwardingType: normalizeBranchForwardingType((account as any).forwardingType),
    token: account.token,
...
function dtoToAccount(dto: FrontendAccount, fallback?: AccountConfig): AccountConfig {
  const base: AccountConfig =
    ...
    ({
      ...
      type: dto.type === "bot" ? "bot" : "selfbot",
      forwardingType: normalizeBranchForwardingType(dto.forwardingType),
      token: dto.token || "",
  ...
  return {
    ...
    type: dto.type === "bot" ? "bot" : "selfbot",
    forwardingType: normalizeBranchForwardingType(dto.forwardingType || base.forwardingType),
